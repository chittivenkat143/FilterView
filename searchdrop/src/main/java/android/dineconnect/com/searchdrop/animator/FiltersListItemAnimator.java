package android.dineconnect.com.searchdrop.animator;
...
public class FiltersListItemAnimator extends SimpleItemAnimator{
    ...
    private class MoveInfo{
        RecyclerView.ViewHolder holder;int fromX=0;int fromY=0;int toX=0;int toY=0;
    ...
    private class ChangeInfo{
        RecyclerView.ViewHolder newHolder;RecyclerView.ViewHolder oldHolder;int fromX=0;int fromY=0;int toX=0;int toY=0;
        public ChangeInfo(@Nullable RecyclerView.ViewHolder newHolder,@Nullable RecyclerView.ViewHolder oldHolder, int fromX, int fromY, int toX, int toY) {
    ...
    private void animateAddImpl(final RecyclerView.ViewHolder holder) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                float ratio = (float) valueAnimator.getAnimatedValue() / 300;
